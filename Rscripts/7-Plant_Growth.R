...
for(i in 2:4) {
    ...
    geom_errorbar(aes(x = days, ymin = plant.growth_time[, i]- plant.growth_time[, i + 6], 
  ...
  ggsave(filename = paste0("Plots/PlantChem/PlantGrowthRate_StdError", colnames[i-1], "_02282022.pdf"), 
         plot = fig_growth,
         width = 10,
         height = 6,
         units ="in")
